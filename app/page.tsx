  ...
  return (
    <main className="min-h-screen flex items-center justify-center py-12 md:py-24" style={{ backgroundColor: '#D9D9D9' }}>
      <div className="flex flex-col items-start max-w-[550px] px-4 gap-4">
        <img src="/subcurrent.svg" alt="Subcurrent" className="w-[30px] md:w-[36px]" />
        <p className="text-sm md:text-base text-left" style={{ fontFamily: '"Old Standard TT", serif', fontWeight: 400 }}>
        <a href="https://www.collinsdictionary.com/dictionary/english/subcurrent" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#D9D9D9] transition-colors duration-200">Subcurrent</a> (noun) describes the hidden directions of thought, intention or action beneath what is visible. It defines both our focus and our name.
